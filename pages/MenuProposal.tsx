...
const INITIAL_PROPOSALS = [
    { id: '1', menuName: 'Soto Ayam Lamongan', submittedBy: 'Surabaya Manager', date: '2023-11-01', price: 28000, status: ProposalStatus.PENDING, description: 'Soto ayam khas Lamongan dengan bubuk koya gurih dan kuah kuning yang kaya rempah.', image: 'https://images.unsplash.com/photo-1628522307525-4c094406e287?auto=format&fit=crop&q=80&w=800' },
    { id: '2', menuName: 'Iced Lychee Tea', submittedBy: 'Jakarta South Manager', date: '2023-11-02', price: 25000, status: ProposalStatus.APPROVED, description: 'Teh leci segar dengan buah leci asli, sangat cocok untuk cuaca panas Jakarta Selatan.', image: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&q=80&w=800' },
    { id: '3', menuName: 'Bubur Ayam Jakarta', submittedBy: 'Jakarta Central Manager', date: '2023-10-30', price: 20000, status: ProposalStatus.REJECTED, description: 'Bubur ayam dengan topping cakwe, ayam suwir, dan kerupuk, menu sarapan favorit.', image: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?auto=format&fit=crop&q=80&w=800' },
    { id: '4', menuName: 'Nasi Padang Komplit', submittedBy: 'Padang Manager', date: '2023-11-05', price: 45000, status: ProposalStatus.PENDING, description: 'Nasi Padang dengan rendang, sayur nangka, dan sambal hijau khas Minang.', image: 'https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?auto=format&fit=crop&q=80&w=800' },
    { id: '5', menuName: 'Gudeg Yu Djum', submittedBy: 'Yogyakarta Manager', date: '2023-11-06', price: 35000, status: ProposalStatus.PENDING, description: 'Gudeg nangka manis dengan krecek pedas dan telur bacem.', image: 'https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?auto=format&fit=crop&q=80&w=800' },
    { id: '6', menuName: 'Empek-Empek Selam', submittedBy: 'Palembang Manager', date: '2023-11-03', price: 30000, status: ProposalStatus.APPROVED, description: 'Pempek kapal selam dengan isian telur besar dan cuko pedas manis.', image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&q=80&w=800' },
    { id: '7', menuName: 'Ayam Betutu Gilimanuk', submittedBy: 'Bali Manager', date: '2023-11-07', price: 55000, status: ProposalStatus.PENDING, description: 'Ayam utuh dengan bumbu rempah khas Bali yang pedas dan aromatik.', image: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?auto=format&fit=crop&q=80&w=800' },
    { id: '8', menuName: 'Coto Makassar', submittedBy: 'Makassar Manager', date: '2023-10-28', price: 38000, status: ProposalStatus.REJECTED, description: 'Soto daging sapi khas Makassar dengan kuah kacang kental.', image: 'https://images.unsplash.com/photo-1572656631137-7935297eff55?auto=format&fit=crop&q=80&w=800' },
    { id: '9', menuName: 'Batagor Riri', submittedBy: 'Bandung Manager', date: '2023-11-04', price: 22000, status: ProposalStatus.APPROVED, description: 'Bakso tahu goreng ikan tenggiri dengan bumbu kacang legit.', image: 'https://images.unsplash.com/photo-1541167760496-1628856ab772?auto=format&fit=crop&q=80&w=800' },
    { id: '10', menuName: 'Mie Aceh Tumis', submittedBy: 'Aceh Manager', date: '2023-11-08', price: 32000, status: ProposalStatus.PENDING, description: 'Mie tebal dengan bumbu kari pedas dan irisan daging sapi.', image: 'https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?auto=format&fit=crop&q=80&w=800' },
    { id: '11', menuName: 'Bika Ambon Zulaikha', submittedBy: 'Medan Manager', date: '2023-11-09', price: 65000, status: ProposalStatus.PENDING, description: 'Kue basah khas Medan dengan tekstur bersarang dan aroma daun jeruk.', image: 'https://images.unsplash.com/photo-1601039641847-7857b994d704?auto=format&fit=crop&q=80&w=800' },
    { id: '12', menuName: 'Rawon Setan', submittedBy: 'Surabaya Manager', date: '2023-11-01', price: 42000, status: ProposalStatus.APPROVED, description: 'Sup daging sapi kuah hitam kluwek yang gurih dan legendaris.', image: 'https://images.unsplash.com/photo-1572656631137-7935297eff55?auto=format&fit=crop&q=80&w=800' },
    { id: '13', menuName: 'Es Pisang Ijo', submittedBy: 'Makassar Manager', date: '2023-11-10', price: 25000, status: ProposalStatus.PENDING, description: 'Pisang balut adonan hijau dengan bubur sumsum dan sirup merah.', image: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&q=80&w=800' },
    { id: '14', menuName: 'Kerak Telor Betawi', submittedBy: 'Jakarta North Manager', date: '2023-10-25', price: 25000, status: ProposalStatus.REJECTED, description: 'Omelet beras ketan dengan serundeng dan telur bebek khas Jakarta.', image: 'https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?auto=format&fit=crop&q=80&w=800' },
    { id: '15', menuName: 'Sate Lilit', submittedBy: 'Bali Manager', date: '2023-11-11', price: 30000, status: ProposalStatus.PENDING, description: 'Sate daging cincang dengan bumbu basa genep yang dililitkan pada batang serai.', image: 'https://images.unsplash.com/photo-1631515243349-e0603690b6b8?auto=format&fit=crop&q=80&w=800' },
];
                ...
                {filteredProposals.map((proposal) => (
                    ...
                    >
                        ...
                        <div className="p-5 flex flex-col flex-1">
                            <div className="mb-4">
                                <p className="text-textPrimary font-bold text-sm">{proposal.submittedBy}</p>
                                <p className="text-textSecondary text-xs">Asal Region Manager</p>
                            </div>
                    ...
                    <div className="w-full max-w-md my-8 relative flex flex-col items-center">
                        ...
                        <div className="bg-[#E5E5E5] w-full rounded-[32px] p-6 space-y-3 shadow-2xl relative animate-in fade-in zoom-in duration-200">
                            ...
                            <div className="flex gap-3">
                                ...
                                <div className="bg-white flex-1 p-3.5 rounded-xl shadow-sm">
                                    <p className="text-[10px] text-gray-400 font-bold mb-1 uppercase">Asal Region Manager</p>
                                    <p className="text-xs font-bold text-[#1F2933] truncate">
                                        {/* Extract Region or show static */}
                                        {selectedProposal.submittedBy.replace(' Manager', '') || 'Jakarta'}
                                    </p>
                                </div>
                            </div>
